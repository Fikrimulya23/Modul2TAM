package com.fikrimulyap.myintentapp;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_move_activity_data:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME,"Fikri Mulya Permana");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 21);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_dial_number:
                String phoneNumber = "082175410563";
                Intent dialPhoneIntent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:" + phoneNumber));
                startActivity(dialPhoneIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("Fikri Mulya Permana");
                mPerson.setAge(21);
                mPerson.setEmail("fikrimulyapermana00@gmail.com");
